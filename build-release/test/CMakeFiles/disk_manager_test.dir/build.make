...
test/CMakeFiles/disk_manager_test.dir/storage/disk_manager_test.cpp.o: ../test/storage/disk_manager_test.cpp
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/15-445/bustub-master/build-release/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object test/CMakeFiles/disk_manager_test.dir/storage/disk_manager_test.cpp.o"
	cd /15-445/bustub-master/build-release/test && /usr/bin/clang++-12  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/disk_manager_test.dir/storage/disk_manager_test.cpp.o -c /15-445/bustub-master/test/storage/disk_manager_test.cpp
...
test/CMakeFiles/disk_manager_test.dir/storage/disk_manager_test.cpp.i: cmake_force
	...
	cd /15-445/bustub-master/build-release/test && /usr/bin/clang++-12 $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /15-445/bustub-master/test/storage/disk_manager_test.cpp > CMakeFiles/disk_manager_test.dir/storage/disk_manager_test.cpp.i
...
test/CMakeFiles/disk_manager_test.dir/storage/disk_manager_test.cpp.s: cmake_force
	...
	cd /15-445/bustub-master/build-release/test && /usr/bin/clang++-12 $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /15-445/bustub-master/test/storage/disk_manager_test.cpp -o CMakeFiles/disk_manager_test.dir/storage/disk_manager_test.cpp.s
...
test/disk_manager_test: test/CMakeFiles/disk_manager_test.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/15-445/bustub-master/build-release/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable disk_manager_test"
	cd /15-445/bustub-master/build-release/test && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/disk_manager_test.dir/link.txt --verbose=$(VERBOSE)
	cd /15-445/bustub-master/build-release/test && /usr/bin/cmake -D TEST_TARGET=disk_manager_test -D TEST_EXECUTABLE=/15-445/bustub-master/build-release/test/disk_manager_test -D TEST_EXECUTOR= -D TEST_WORKING_DIR=/15-445/bustub-master/build-release/test -D "TEST_EXTRA_ARGS=--gtest_color=auto;--gtest_output=xml:/15-445/bustub-master/build-release/test/disk_manager_test.xml;--gtest_catch_exceptions=0" -D "TEST_PROPERTIES=TIMEOUT;120" -D TEST_PREFIX= -D TEST_SUFFIX= -D NO_PRETTY_TYPES=FALSE -D NO_PRETTY_VALUES=FALSE -D TEST_LIST=disk_manager_test_TESTS -D CTEST_FILE=/15-445/bustub-master/build-release/test/disk_manager_test[1]_tests.cmake -D TEST_DISCOVERY_TIMEOUT=120 -P /usr/share/cmake-3.16/Modules/GoogleTestAddTests.cmake
...
test/CMakeFiles/disk_manager_test.dir/clean:
	cd /15-445/bustub-master/build-release/test && $(CMAKE_COMMAND) -P CMakeFiles/disk_manager_test.dir/cmake_clean.cmake
